{
  description = "misinformation-defence-platform - {project-description}";
    ...
    flake-utils.lib.eachDefaultSystem (system:
      ...
      in
      {
        ...
        devShells.default = pkgs.mkShell {
          ...
          shellHook = ''
            echo "🚀 misinformation-defence-platform development environment"
            echo "Language: mixed"
            echo ""
        ...
        packages.default = pkgs.stdenv.mkDerivation {
          ...
          buildPhase = ''
            ...
            # For Ada: gprbuild -P misinformation-defence-platform.gpr -XMODE=release
          '';

          installPhase = ''
            mkdir -p $out/bin
            # *REMINDER: Add install commands*
            # cp target/release/misinformation-defence-platform $out/bin/  # Rust
            # cp bin/misinformation-defence-platform $out/bin/  # Ada
          '';
        ...
        apps.default = {
          type = "app";
          program = "${self.packages.${system}.default}/bin/misinformation-defence-platform";
        };
        ...
        checks = {
          ...
          test = pkgs.runCommand "test-misinformation-defence-platform" {
