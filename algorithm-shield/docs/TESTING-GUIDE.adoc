...
[ ] **Background page runs**
   ...
   - Console should show: "🛡️ Algorithm Shield background worker active"
   - No errors in console

[ ] **Content script injects**
   - Open any website (e.g., youtube.com)
   - Open Developer Tools (F12)
   - Console should show: "🛡️ Algorithm Shield active"
   - No errors
...
3. Verify logs:
   ...
   - "👁️ Observing feed..." (when scrolling)
...
**Popup console**:
```
Right-click icon → Inspect popup → Console
```

**Content script console**:
```
Any web page → F12 → Console
```
